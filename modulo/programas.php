<div class="container container-fluid " style="padding-left: 30px;">
	...
	<div class="row">
		<div class="col-md 12">
				...
				<p class="lead">Cada uno de nuestros programas de inteligencia emocional se diseñaron para mejorar, incrementar y fortalecer el compromiso de los trabajadores y la productividad, generando mayores ingresos y el éxito de la organización.</p>
					<div class="divider"></div>
				<h3>Programa de Capacitación de Un Día de Inteligencia Emocional Aplicada</h3>
				<p class="lead">Nuestro programa específicamente diseñado de un día es ideal para ayudar a los participantes a explorar y poner en práctica métodos de aplicación de herramientas de inteligencia emocional en el trabajo. Estos métodos y herramientas de comportamiento también pueden usarse, por supuesto, fuera del trabajo, en las relaciones personales de los participantes.</p>
				<p class="lead">Utilizando las herramientas y técnicas que se exploran y practican en este programa, los participantes pueden lograr mejoras en estas áreas:</p>
				...
				<p class="lead">El programa de un día es una manera ideal de presentar a sus colaboradores los beneficios y usos de la consciencia emocional de sí mismos y puede ser el punto de partida perfecto para desarrollos subsiguientes a lo largo y ancho de su organización.
				</p>
		</div>
	</div>
	<br><br>
