...
/*la version que se vera el movil*/
		...
		<div class="row">
			...
			<div class="col-sm-12 ">
				<form>
					...
					<div class="form-group col-xs-6">
						<label>¿Como se entero de este programa de certificaciòn?</label>
						<input type="email" class="form-control" id="" name="" alt="" required " />
					</div>
					<div class="form-group col-xs-6">
						<label>¿Aplicarìa evaluaciones a su propia Empresa o sus clientes?</label>
						<input type="email" class="form-control" id="" name="" alt="" required " />
					</div>
